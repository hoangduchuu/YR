...
class _RotatePinWheelState extends State<RotatePinWheel> with SingleTickerProviderStateMixin {
    ...
    return Container(
      child: new AnimatedBuilder(
          ...
          builder: (BuildContext context, Widget _widget) {
            return Transform.rotate(angle: (animationController.value * math.pi), child: _widget);
          }),
    );
  }
...
class PinwheelPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Rect rect = new Rect.fromCircle(center: offset, radius: math.min((size.width / 2), (size.height / 2)));
