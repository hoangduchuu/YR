            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                CommonButton(
                    ...
                    text: Text('Đăng ký',style: TextStyle(fontFamily: Hfonts.PrimaryFontBold,fontSize: 16),),
                ...
                new Row(
                  ...
                  children: <Widget>[
                    Text('Đã có tài khoản?',style: TextStyle(color: HColors.white,fontFamily: Hfonts.PrimaryFontRegular,fontSize: 17,fontWeight: FontWeight.bold),),
                    FlatButton(
                      child: new Text(
                        "Đăng nhập ngay",
                        style: TextStyle(
